...
//          */
//
//      $('.main-menu').once('demonstratieMenu', function () {
//        var menu = $(this).data('trigger', counter).addClass('collapsible-menu-' + counter),
//            menuTitle = getTitle(menu),
//            triggerLabel = triggerText(menuTitle),
//            trigger = $('<a>').data('menu', counter).attr({
...
//  };
//
///* change zipcode input box size */
//
//    document.getElementById("edit-distance-1-postal-code").size = "7";
//    document.getElementById("edit-distance-postal-code").size = "7";
//    document.getElementById("edit-distance-search-distance").size = "7";
//    document.getElementById("edit-distance-1-search-distance").size = "7";
