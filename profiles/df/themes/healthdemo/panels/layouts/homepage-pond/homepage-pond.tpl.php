...
<div class="panel-display pond clearfix container <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="pond-container pond-header clearfix panel-panel row-fluid">
    <div class="pond-container-inner pond-header-inner panel-panel-inner span12">
      <?php print $content['header']; ?>
    </div>
  </div>
  
  <div class="pond-container pond-column-content pond-column-content-row1  row-fluid">
